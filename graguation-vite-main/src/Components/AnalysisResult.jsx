...
// REMOVED: import playerData from '../assets/player_analysis_fixed.json'; // This line is removed or commented out
...
// MODIFIED: TennisMatchDashboard now accepts 'playerData' as a prop
function TennisMatchDashboard({ data: playerData }) { // Renamed 'data' prop to 'playerData' for internal consistency
        ...
        return (
            <div className="tennis-dashboard-container"> {/* Added this class */}
                <div className="no-data-message">
                    ...
                    <p>Please upload a video and run analysis to see results.</p>
                </div>
            </div>
        );
    }
    ...
    const getPlayerIds = () => {
        ...
        const sections = ['trajectories', 'heatmaps', 'ball_hit_locations', 'role',
            ...
            'player_contribution_advice', 'stamina_drop_time', 'stamina_advice', 'zone_presence_percentages']; // Ensure zone_presence_percentages is included
